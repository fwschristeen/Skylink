...
class AddProductBottomSheet extends StatefulWidget {
  ...
  const AddProductBottomSheet({super.key, required this.currentUser});
...
class _AddProductBottomSheetState extends State<AddProductBottomSheet> {
  ...
  ProductType _selectedType = ProductType.drone;
  List<String> _imageUrls = [];
  String? _videoUrl;
  bool _isUploading = false;
  Map<String, dynamic> _productSpecs = {};
    ...
    try {
      ...
      for (var image in images) {
        final ref = _storage.ref().child(
          'products/${widget.currentUser.uid}/${_uuid.v4()}.jpg',
        );
  ...
  Future<void> _pickVideo() async {
    try {
      ...
      final ref = _storage.ref().child(
        'products/${widget.currentUser.uid}/${_uuid.v4()}.mp4',
      );
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      debugPrint('Current user ID: ${widget.currentUser.uid}');
      debugPrint('Current user name: ${widget.currentUser.name}');
      debugPrint('Current user role: ${widget.currentUser.role}');
      ...
      debugPrint('Adding product with ID: ${product.id}');
      debugPrint('Product type: ${product.type}');
